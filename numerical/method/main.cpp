...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        D3DCOLOR clear_col_dx = D3DCOLOR_RGBA((int)(state_t.clear_color.x * state_t.clear_color.w * 255.0f), (int)(state_t.clear_color.y * state_t.clear_color.w * 255.0f), (int)(state_t.clear_color.z * state_t.clear_color.w * 255.0f), (int)(state_t.clear_color.w * 255.0f));
